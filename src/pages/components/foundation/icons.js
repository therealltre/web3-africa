          ...
          <Stack spacing={3}>
            ...
            <Box sx={{ position: 'relative' }}>
              <Block title="Local Icons" sx={style}>
                <SvgIconStyle src="/assets/icons/browser-edge.svg" />
                <SvgIconStyle
                  src="/assets/icons/browser-edge.svg"
                ...
                />
                <SvgIconStyle
                  src="/assets/icons/elephant.svg"
                  sx={{ color: 'info.main' }}
                />
                <SvgIconStyle
                  src="/assets/icons/json-logo.svg"
                  sx={{ color: 'success.main' }}
                />
                <SvgIconStyle
                  src="/assets/icons/love-camera.svg"
